  ...
  <div class="py-12">
      <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
          <div class="bg-white shadow-md rounded-lg p-6">
              <h1 class="text-2xl font-bold text-gray-800 mb-4">Edit shs Student</h1>
              ...
              <!-- Form -->
              <form method="post" action="{{ route('student.update', ['student' => $student]) }}" class="space-y-4">
                  @csrf
                  @method('put')
                  ...
                  <label for="year_level" class="block text-gray-700 font-medium">Year Level</label>
                    ...
                    <div>
                        <label for="course" class="block text-gray-700 font-medium">Strand</label>
